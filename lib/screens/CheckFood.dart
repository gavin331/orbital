                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      // Check if the food name is present in the common allergens list
                      ...
                      if (!isCommonAllergen) {
                        _buildAlertDialog(
                          ...
                          dialogType: DialogType.warning,
                          title: 'Warning',
                          desc: 'We were unable to check and cannot give you a definite answer now.'
                      ...
                      bool result = await _fireStoreService.checkUserAllergenicFoods(foodName);
                      List<String> commonAllergen = await _fireStoreService.findCommonAllergensForCheckFood(foodName);
                      if (context.mounted) {
                        if (result) {
                          _buildAlertDialog(
                            context: context,
